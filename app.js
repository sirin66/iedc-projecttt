...
// Production credentials and configuration loaded from window.ENV_CONFIG (Vanilla JS static integration)
const ENV = window.ENV_CONFIG || {};
const ADMIN_EMAIL = ENV.ADMIN_EMAIL || "";
const ADMIN_PASSWORD = ENV.ADMIN_PASSWORD || "";
const GATE_PASSWORD_PRIMARY = ENV.GATE_PASSWORD_PRIMARY || "";
const GATE_PASSWORD_SECONDARY = ENV.GATE_PASSWORD_SECONDARY || "";

// --- FIREBASE CONFIG ---
const FB_API_KEY = ENV.FIREBASE_API_KEY || "";
const FB_AUTH_DOMAIN = ENV.FIREBASE_AUTH_DOMAIN || "";
const FB_PROJECT_ID = ENV.FIREBASE_PROJECT_ID || "";
const FB_STORAGE_BUCKET = ENV.FIREBASE_STORAGE_BUCKET || "";
const FB_SENDER_ID = ENV.FIREBASE_MESSAGING_SENDER_ID || "";
const FB_APP_ID = ENV.FIREBASE_APP_ID || "";
const FB_MEASUREMENT_ID = ENV.FIREBASE_MEASUREMENT_ID || "";
