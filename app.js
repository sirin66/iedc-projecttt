...
const FB_API_KEY = atob("QUl6YVN5RDRfaDNXVTJ0a3pFNUc2alhpbVFVallqMmJVVmxpWVVr");
const FB_AUTH_DOMAIN = atob("aWVkYy11eC5maXJlYmFzZWFwcC5jb20=");
const FB_PROJECT_ID = atob("aWVkYy11eA==");
const FB_STORAGE_BUCKET = atob("aWVkYy11eC5maXJlYmFzZXN0b3JhZ2UuYXBw");
const FB_SENDER_ID = atob("MzYyMjYwMzUyMzA0");
const FB_APP_ID = atob("MTozNjIyNjAzNTIzMDQ6d2ViOjI3Mzc0ZGJiOWI1MTE4MjgwN2NjZjU=");
const FB_MEASUREMENT_ID = atob("Ry0yS0gwOE1OR1NY");

// --- OBFUSCATED SUPABASE CONFIG ---
const SUPABASE_URL = atob("aHR0cHM6Ly9xY3FuZXlheXlhaWVla3JveXhkdC5zdXBhYmFzZS5jbw==");
const SUPABASE_ANON_KEY = atob("U2JfcHVibGlzaGFibGVfMENFMUNsMU9MR01SemlRVTJZN2pnZ192cThlUERCZg==");

// --- OBFUSCATED EMAILJS CONFIG ---
const EMAILJS_SERVICE_ID = atob("c2VydmljZV91NHZlNmcy");
const EMAILJS_TEMPLATE_ID = atob("dGVtcGxhdGVfMHp2ZjJycw==");
const EMAILJS_PUBLIC_KEY = atob("M2VOTHkydFU4bVFFaVFJcUc=");
...
// Securely check and wait for correct Firebase config API Key setup
if (firebaseConfig.apiKey && firebaseConfig.apiKey !== "undefined" && firebaseConfig.apiKey !== "") {
  try {
    if (typeof firebase !== "undefined") {
      ...
      console.log("Firebase initialized successfully inside client engine from global setup.");
    } else {
  ...
  console.warn("Firebase API key is missing or empty. Simulator mode enabled.");
}
